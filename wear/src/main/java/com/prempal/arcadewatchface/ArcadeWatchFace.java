package com.prempal.arcadewatchface;
...
public class ArcadeWatchFace {

    private static final String TIME_FORMAT_WITHOUT_SECONDS = "%02d.%02d";
    private static final String TIME_FORMAT_WITH_SECONDS = TIME_FORMAT_WITHOUT_SECONDS;
    ...
    public static ArcadeWatchFace newInstance(Context context) {
        Paint timePaint = new Paint();
        timePaint.setColor(DATE_AND_TIME_DEFAULT_COLOUR);
        timePaint.setTextSize(context.getResources().getDimension(R.dimen.time_size));
        timePaint.setTypeface(Typeface.createFromAsset(context.getAssets(), "ka1.ttf"));
        ...
        datePaint.setTypeface(Typeface.createFromAsset(context.getAssets(), "ka1.ttf"));

        Paint backgroundPaint = new Paint();
        backgroundPaint.setColor(BACKGROUND_DEFAULT_COLOUR);

        return new ArcadeWatchFace(timePaint, datePaint, backgroundPaint, new Time());
    }

    ArcadeWatchFace(Paint timePaint, Paint datePaint, Paint backgroundPaint, Time time) {
    ...
    public void draw(Canvas canvas, Rect bounds) {
        ...
        String timeText = String.format(shouldShowSeconds ? TIME_FORMAT_WITH_SECONDS : TIME_FORMAT_WITHOUT_SECONDS, time.hour, time.minute);
